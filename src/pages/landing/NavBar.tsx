      ...
      >
        <Container className="container-fluid">
          <Link to="/" className="logo text-uppercase">
            <img src={logo} alt="" className="logo-light" height="40" />
            <img src={logo1} alt="" className="logo-dark" height="40" />
          </Link>
          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            ...
            <form action="/auth/login" method="get">
              <button type="submit" className="btn btn-info navbar-btn">Sign In</button>
            </form>
          </Navbar.Collapse>
        </Container>
      </Navbar>
